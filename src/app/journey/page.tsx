...
export const metadata: Metadata = {
  ...
  description:
    'Discover the traditional process behind RA Enterprises spices — from farm sourcing and sun-drying to stone grinding and quality packaging.',
};
      ...
      <div className="relative bg-gradient-to-br from-amber-950 to-red-950 py-20 px-4 text-center overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="mt-5 text-amber-200 max-w-2xl mx-auto text-base leading-relaxed">
            Every packet of RA Enterprises masala is the result of a meticulous, six-step
